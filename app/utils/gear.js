const gears = {
  ...
  "[9999] Armor":{
    "Helmet":{
      ...
      "Optimal": ["Critical Damage", "Normal Amplification", "Basic Stats", "Attack/Intensity", "Accuracy"],
      "Type": "Type A"
    },
    "Chestplate":{
      "DI": 7.671,
      ...
      "Optimal": ["Maximum Damage", "Basic Stats %", "Attack/Intensity %", "Basic Stats", "Attack/Intensity"],
      "Type": "Type A"
    },
    "Fauld":{
      "DI": 7.671,
    ...
    "Gloves":{
      ...
      "Optimal": ["Critical Damage", "Attack/Intensity %", "Boss Amplification", "Basic Stats", "Attack/Intensity"],
      "Type": "Type A"
    },
    "Boots":{
      "DI": 7.214,
      ...
      "Optimal": ["Critical Damage", "Basic Stats %", "Attack/Intensity", "Basic Stats", "Movement Speed"],
      "Type": "Type A"
    },
    "Sheet Link": "https://docs.google.com/spreadsheets/d/11CI-FMnoX1_D9oPgbY1cAKplOdvaOkkPzZnJ6-3l7IU/edit?usp=sharing",
    "Potential": [0.15, 0.15]
  },
  "[9999] Badge 6":{
    "Badge":{
  ...
  "[9000] Accessories":{
    "Crystal":{
      ...
      "Optimal": ["Critical Damage", "Basic Stats %", "Minimum Damage", "Boss Amplification", "Attack/Intensity"],
      "Type": "Type A"
    },
    "Glasses":{
      "DI": 4.800,
    ...
    "Stockings":{
      ...
      "Optimal": ["Dual Damage", "Minimum Damage", "Normal Amplification", "Attack/Intensity", "Basic Stats"],
      "Type": "Type A"
    },
    "Sheet Link": "https://docs.google.com/spreadsheets/d/1sN-2_7OVKn_fZlMOOreEBq2J3160lEsZrfShgoXFYWE/edit?usp=sharing",
    "Potential": [0.12, 0.12]
  },
  "[8000] Weapons":{
    "Weapon":{
  ...
  "[6000] Armor":{
    "Helmet":{
      ...
      "Optimal": ["Critical Damage", "Strength/Magic", "Normal Amplification", "Basic Stats", "Accuracy"],
      "Type": "Type A"
    },
    "Chestplate":{
      "DI": 9.07,
    ...
    "Gloves":{
      ...
      "Optimal": ["Critical Damage", "Attack/Intensity %", "Boss Amplification", "Strength/Magic", "Basic Stats"],
      "Type": "Type A"
    },
    "Boots":{
      "DI": 10.41,
